$_RecycleBinNativeMethodSignature = @'
    ...
    function Clear-RecycleBin {
        ...
        begin {
            if (-not ('RecycleBinNativeMethods.RecycleBinAPI' -as [type])) {
                $addTypeParams = @{
                    MemberDefinition = $_RecycleBinNativeMethodSignature;
                    Name             = "RecycleBinAPI";
        ...
        process {
            ...
            $r = [RecycleBinNativeMethods.RecycleBinAPI]::SHEmptyRecycleBin([System.IntPtr]::Zero, $DriveLetter, $dwFlags)
